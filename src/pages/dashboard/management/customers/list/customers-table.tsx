...
export function CustomersTable() {
  ...
  const createNewCustomerClosure = useDisclosure(false);

  const [opened, { open, close }] = createNewCustomerClosure;
  ...
  return (
    <DataTable.Container>
      <DataTable.Title
        ...
        actions={
          <AddButton variant="default" size="xs" onClick={open}>
            Add new customer
          </AddButton>
        }
      />
      <AppDrawer title="Create a new customer" position="right" closure={createNewCustomerClosure}>
